...
int main(void) {
    while(true) {
        ...
        front_left  = front_left  + Controller1.Axis3.position(pct);
        back_left   = back_left   + Controller1.Axis3.position(pct);
        front_right = front_right - Controller1.Axis3.position(pct);
        back_right  = back_right  - Controller1.Axis3.position(pct);

        front_left = front_left + Controller1.Axis4.position(pct);
        back_left = back_left - Controller1.Axis4.position(pct);
        front_right = front_right + Controller1.Axis4.position(pct);
        back_right = back_right - Controller1.Axis4.position(pct);
